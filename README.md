...
- 🏷️ Shows the selected place name on the map.
- 🍏 Keeps the marker visible while you work.
- 🕘 Saves recent places locally for quick reuse.
- 🌫️ Includes optional small GPS drift for more natural movement tests.
...
- ⏯️ Routes can pause, resume, stop, or hold at the destination.
...
- ♾️ Can loop back to the first point.
...
- 🖥️ No browser tab or localhost UI is required for the packaged app.
